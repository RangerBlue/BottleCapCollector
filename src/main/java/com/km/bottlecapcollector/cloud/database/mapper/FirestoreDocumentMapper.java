...
import com.km.bottlecapcollector.cloud.database.document.EmbeddingEntity;
...
import com.km.bottlecapcollector.cloud.database.document.StorageImageEntity;
...
@Mapper
public interface FirestoreDocumentMapper {

    FirestoreDocumentMapper INSTANCE = Mappers.getMapper(FirestoreDocumentMapper.class);
